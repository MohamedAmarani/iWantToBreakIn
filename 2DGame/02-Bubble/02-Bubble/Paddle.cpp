...
void Paddle::update(int deltaTime)
{
	...
	{
		posPaddle.x -= 2;
		if (map->collisionMoveLeft(posPaddle, glm::ivec2(32, 32)))
		{
			posPaddle.x += 2;
		}
	}
	...
	{
		posPaddle.x += 2;
		if (map->collisionMoveRight(posPaddle, glm::ivec2(32, 32)))
		{
			posPaddle.x -= 2;
		}
	}
	...
	{
		posPaddle.y -= 2;
		if (map->collisionMoveUp(posPaddle, glm::ivec2(32, 32)))
		{
			posPaddle.y += 2;
		}
	}
	...
	{
		posPaddle.y += 2;
		if (map->collisionMoveDown(posPaddle, glm::ivec2(32, 32)))
		{
			posPaddle.y -= 2;
		}
	}
