...
void Player::init(const glm::ivec2 &tileMapPos, ShaderProgram &shaderProgram)
{
	...
	sprite->addKeyframe(MOVE_RIGHT, glm::vec2(0.50, 0.25f));
	sprite->addKeyframe(MOVE_RIGHT, glm::vec2(0.75, 0.25f));

	sprite->setAnimationSpeed(MOVE_UP, 8);
	sprite->addKeyframe(MOVE_UP, glm::vec2(0.f, 0.50f));
	sprite->addKeyframe(MOVE_UP, glm::vec2(0.25, 0.50f));
	sprite->addKeyframe(MOVE_UP, glm::vec2(0.50, 0.50f));
	sprite->addKeyframe(MOVE_UP, glm::vec2(0.75, 0.50f));
